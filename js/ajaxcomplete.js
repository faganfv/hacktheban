function callSearch() {
  ...
  ajax.onload = function() {
      ...
      for(i=0; i < questions.length; i++) {
        ...
        "<div class=\"mdl-grid\"><div class=\"demo-card-wide mdl-card mdl-shadow--2dp mdl-cell--8-col qa-card\"><div class=\" mdl-card__title\"><h1 class=\"mdl-card__title-text\">" + questions[i] + "</h1><hr></div><div class=\"mdl-card__supporting-text\">" + answers[i] + "</div><div class=\"mdl-card__actions mdl-card--border\">" + authors[i] + ", " + dates[i] + "</div>";
      }
    }
  };
  ajax.send();
